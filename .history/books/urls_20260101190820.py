...
from books.views import BookCreate, BookDetailView, BookListView, LibraryDetailView, LibraryListView, ShelfCreate, ShelfDetailView, ShelfListView, LibraryCreate
