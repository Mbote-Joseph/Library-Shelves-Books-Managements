...
from books.views import BookDetailView, BookListView, LibraryDetailView, LibraryListView, ShelfDetailView, ShelfListView, LibraryCreate
...
urlpatterns = [
    ...
    path('shelf-create', LibraryCreate.as_view(), name="shelf.create"),
]